...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/TrackerCommonData/data/PhaseII/BarrelEndcap/pixfwd.xml', 
        ...
        'Geometry/TrackerCommonData/data/PhaseII/BarrelEndcap/trackerStructureTopology.xml',
        'Geometry/TrackerSimData/data/PhaseII/BarrelEndcap/trackersens.xml',
