...
// Thu Apr  9 14:44:08 2015 by ROOT version 5.34/26
// from TTree tree/
// found on file: /home/rossin/data/rossin/EOS/SingleMuonFlatOneOverPt0p0005To5_tt27_cfi_py_GEN_SIM_DIGI_L1TrackTrigger_ntuple.root
//////////////////////////////////////////////////////////

#ifndef stubsNtuple_h
#define stubsNtuple_h
...
public :
   ...
   stubsNtuple(TString sTree, TTree* tree);
   virtual ~stubsNtuple();
...
#ifdef stubsNtuple_cxx
stubsNtuple::stubsNtuple(TString sTree, TTree* tree) : fChain(0)
{
...
stubsNtuple::~stubsNtuple()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t stubsNtuple::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t stubsNtuple::LoadTree(Long64_t entry)
{
...
void stubsNtuple::Init(TTree *tree)
{
...
void stubsNtuple::Show(Long64_t entry)
{
...
Int_t stubsNtuple::Cut(Long64_t entry)
{
