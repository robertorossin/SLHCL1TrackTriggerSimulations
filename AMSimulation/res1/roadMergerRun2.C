...
//	   if (iMerged%100==0) cout << iMerged << "\t" << indFromMerged->size() << endl;
   ...
   if (fChain == 0) {
  	 std::cout << "fChain is a null pointer" << std::endl;
  	 return;
   }
   ...
   newtree->Branch("AMTTRoads_patternRef", &nStubs  );
...
//		  mr.getNstubs(nnStubs);
	      ...
	      for (unsigned iLay=0; iLay<nstubRefs.size(); ++iLay) {
	          nStubsPerRoad += nstubRefs.at(iLay).size();
	      }
...
void roadMergerRun2(unsigned iProc=0,unsigned merging=2,unsigned int iEv=100000000,bool makePlots=false, bool debug=false) {
...
//    if (iProc==2) {fName=TString("/data/rossin/EOS/tt27_sf1L0x2L5x2_nz8_pt3_20160308/tracks_LTF_Neutrino_PU140_tt27_sf1L0x2L5x2_nz8_pt3_5oo6_95c_chi100_300M.root"); pName=TString ("PU140_sf1L0x2L5x2_nz8");}
    ...
    if (iProc==50){fName=TString("/data/rossin/EOS/tt27_sf1L0x2L5x2_nz4_pt3_20160308/roads_SingleMuonTest_PU0_tt27_sf1L0x2L5x2_nz4_pt3_5oo6_100c_300M.root");         pName=TString ("SingleMuTest_PU0_sf1L0x2L5x2_nz4");}
    if (iProc==51){fName=TString("/data/rossin/EOS/tt27_sf1L0x2L5x2_nz6_pt3_20160308/roads_SingleMuonTest_PU0_tt27_sf1L0x2L5x2_nz6_pt3_5oo6_100c_300M.root");         pName=TString ("SingleMuTest_PU0_sf1L0x2L5x2_nz6");}
    if (iProc==52){fName=TString("/data/rossin/EOS/tt27_sf1L0x2L5x2_nz8_pt3_20160308/roads_SingleMuonTest_PU0_tt27_sf1L0x2L5x2_nz8_pt3_5oo6_100c_300M.root");         pName=TString ("SingleMuTest_PU0_sf1L0x2L5x2_nz8");}
	roadMerger rm(fName);
