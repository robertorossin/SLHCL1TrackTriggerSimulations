...
int main(int argc, char **argv) {
    ...
    config.add_options()
        ...
        ("bank_subLadderSize"      , po::value<int>(&bankOption.subLadderSize)->default_value(1), "Specify the size of a subladder (a.k.a. segment)")
        ("bank_subModuleSize"      , po::value<int>(&bankOption.subModuleSize)->default_value(2), "Specify the size of a submodule (a.k.a. superstrip)")
