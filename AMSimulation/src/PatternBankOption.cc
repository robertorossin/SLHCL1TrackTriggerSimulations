...
std::ostream& operator<<(std::ostream& o, const PatternBankOption& po) {
    ...
    o << "unitPhi: " << po.unitPhi << "  unitZ: " << po.unitZ << "  subLadderSize: " << po.subLadderSize << "  subModuleSize: " << po.subModuleSize << "  nLayers: " << po.nLayers << "  nMisses: " << po.nMisses << "  nFakers: " << po.nFakers << "  nDCBits: " << po.nDCBits << "  useVariableSize: " << po.useVariableSize << "  requireTriggerTower: " << po.requireTriggerTower << std::endl;
    o << "subLadderVarSize: ";
