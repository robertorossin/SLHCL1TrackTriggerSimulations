...
std::ostream& operator<<(std::ostream& o, const PatternBankOption& po) {
    ...
    o << "unitPhi: " << po.unitPhi << "  unitEta: " << po.unitEta << "  scalePhi: " << po.scalePhi << "  divideZ: " << po.divideZ << "  subLadderSize: " << po.subLadderSize << "  subModuleSize: " << po.subModuleSize << "  nLayers: " << po.nLayers << "  nMisses: " << po.nMisses << "  nFakers: " << po.nFakers << "  nDCBits: " << po.nDCBits << "  mode: " << po.mode << "  requireTriggerTower: " << po.requireTriggerTower << std::endl;
    o << "subLadderVarSize: ";
